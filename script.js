const projects = [
  ...
  {slug:'moon-jar',title:'Moon Jar',tags:'Phone accessories · CMF',summary:'A phone-accessory concept study developed at Designskin, exploring how Korean visual identity could translate to an international market.',role:'Product design intern · Designskin',year:'2025',tools:'User research, market research, and material and CMF research',overviewTitle:'',overview:'Designskin wanted to retain a recognizable Korean identity while expanding internationally. I conducted user, market, and material research, then translated traditional ceramics, hardware, motifs, and embroidery techniques into phone-accessory concepts.',hero:'images/moon-jar/ceramic-forms-hd.png',heroAlt:'Four phone cases in white, pink, celadon green, and black with ceramic-inspired forms and embossed medallions',heroWide:true,heroDescription:'Moon jar inspired phone cases explore rounded ceramic silhouettes and white, pink, celadon, and black finishes. A proposed injection-molded TPU construction provides flexibility and impact resistance while supporting translucent, matte, high-gloss, and embossed surface treatments.',hideImageLabels:true,galleryContain:true,detailImages:[{src:'images/moon-jar/metal-fittings-hd.png',alt:'White and black phone cases with metal phone grips based on Korean door and furniture hardware',caption:'Traditional hardware',description:'Metal phone-grip concepts reinterpret decorative fittings and pull rings found on traditional Korean doors and furniture.'},{src:'images/moon-jar/textile-patterns-hd.png',alt:'Four textile-like phone cases with crane and traditional Korean pattern variations',caption:'Motif and pattern study',description:'Pattern studies apply cranes and other traditional Korean motifs to textile-like case surfaces for a less literal cultural reference.'},{src:'images/moon-jar/illustrated-motifs-hd.png',alt:'Three phone cases with embroidered rabbit motifs and clothing-style name tags',caption:'Embroidery and personalization',description:'Embroidery studies highlight Designskin’s production technique through stitched character motifs and customizable clothing-style name tags.'}],processTitle:'Internship process',process:'Research findings were developed into four directions: ceramic-inspired CMF and embossing, metal grips based on traditional hardware, Korean motif studies, and embroidered personalization.',hideFinal:true},
