const projects = [
  ...
  {slug:'moon-jar',title:'Moon Jar',tags:'Phone accessories · CMF',summary:'A phone-case concept study developed during my product design internship at Designskin.',role:'Product design intern · Designskin',year:'2025',tools:'Market research, visual development, CAD and rendering',overviewTitle:'',overview:'I researched global phone-accessory trends and developed concepts applying Korean ceramic forms, metal fittings, textile patterns, and illustrated motifs.',hero:'images/moon-jar/ceramic-forms-hd.png',heroAlt:'Four phone cases in white, pink, celadon green, and black with ceramic forms and circular medallions',heroWide:true,hideImageLabels:true,galleryContain:true,detailImages:[{src:'images/moon-jar/metal-fittings-hd.png',alt:'White and black phone cases with Korean metal fitting details',caption:'Metal fittings'},{src:'images/moon-jar/textile-patterns-hd.png',alt:'Four fabric phone cases with crane and traditional pattern variations',caption:'Textile patterns'},{src:'images/moon-jar/illustrated-motifs-hd.png',alt:'Three leather phone cases with illustrated rabbit motifs',caption:'Illustrated motifs'}],processTitle:'Internship process',process:'I moved from market research and visual references into multiple CMF and form directions, then developed the selected ideas through CAD and rendering.',hideFinal:true},
